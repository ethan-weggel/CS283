...
3. Please provide a link to the repository you are using for this class.
    - https://github.com/ethan-weggel/CS283

4. Briefly describe what you want to get out of this class.
    - I genuinely would like to get a better understanding of how C can directly interact with the computer. Similar to how it was said in class, "this stuff is not magic" (even though it might feel like it sometimes). So I would like to know how C is directly manipulating the machine so there isn't anything going on in the background I don't know about. I also think learning advanced C would greatly expand my abilities as a developer.

5. Briefly describe any concerns you might be having with being successful in this class (if any).
    - I am a little worried about the workload just because C assignments can be lengthy by default. However, I will be sure to give the class my all since I am genuinely interested in learning this stuff.